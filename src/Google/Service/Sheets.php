...
class Google_Service_Sheets_SpreadsheetsValues_Resource extends Google_Service_Resource
{
   ...
   */
  public function update($spreadsheetId, $range, Google_Service_Sheets_ValueRange $postBody, $optParams = array())//Focus
  {
...
class Google_Service_Sheets_UpdateValuesResponse extends Google_Model	//Focus
{
  protected $internal_gapi_mappings = array(
  );
  public $spreadsheetId;
